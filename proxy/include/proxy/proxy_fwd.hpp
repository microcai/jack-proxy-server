...
namespace proxy
{
	...
	using span_response = http::response<span_body, http::basic_fields<pmr_alloc_t>>;
	...
	using span_response_serializer = http::response_serializer<span_body, http::basic_fields<pmr_alloc_t>>;
